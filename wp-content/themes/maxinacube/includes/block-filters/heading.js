...
addFilter(
	...
	'maxinacube/heading-block-attributes',
	...
	return (props) => {
		...
		return (
			<Fragment>
				<BlockEdit {...props} />
				<InspectorControls>
					<PanelBody title={__('General', 'maxinacube-theme')}>
						<PanelRow>
							<SelectControl
								label={__('Apply different heading style', 'maxinacube-theme')}
								help={__(
								...
								options={[
									{
										label: __('Default Heading Style', 'maxinacube-theme'),
										value: '',
									},
									{
										label: __('H1', 'maxinacube-theme'),
										value: 'has-style-h1',
									},
									{
										label: __('H2', 'maxinacube-theme'),
										value: 'has-style-h2',
									},
									{
										label: __('H3', 'maxinacube-theme'),
										value: 'has-style-h3',
									},
									{
										label: __('H4', 'maxinacube-theme'),
										value: 'has-style-h4',
									},
									{
										label: __('H5', 'maxinacube-theme'),
										value: 'has-style-h5',
									},
									{
										label: __('H6', 'maxinacube-theme'),
										value: 'has-style-h6',
									},
								]}
								onChange={(value) => {
...
addFilter('editor.BlockEdit', 'maxinacube/filter-heading-block-ui', HeadingBlockUI);
...
addFilter(
	...
	'maxinacube/save-heading-changes',
	saveHeadingChanges,
);
