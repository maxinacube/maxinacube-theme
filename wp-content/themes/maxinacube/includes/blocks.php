...
namespace MaxinacubeTheme\Blocks;
...
function setup(): void {
	...
	add_filter( 'maxinacube_available_blocks', function ( $blocks ) {
...
function blocks_editor_styles(): void {
	wp_enqueue_style(
		...
		MAXINCUBE_THEME_TEMPLATE_URL . '/dist/css/editor-style-overrides.css',
		[],
	...
	if ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) {
		wp_enqueue_script(
			'editor-style-overrides',
			MAXINCUBE_THEME_TEMPLATE_URL . '/dist/js/editor-style-overrides.js',
...
function register_block_pattern_categories(): void {
	...
	register_block_pattern_category(
		'maxinacube-theme',
		[ 'label' => __( 'Maxinacube', 'maxinacube-theme' ) ]
	);
}
