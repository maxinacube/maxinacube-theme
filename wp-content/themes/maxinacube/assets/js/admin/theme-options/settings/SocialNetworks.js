...
const SocialNetworks = ({ updateData, isOpen }) => {
	...
	return (
		<PanelBody title={__('Social Networks', 'maxinacube-theme')} initialOpen={!!isOpen}>
			<PanelRow>
				<div className="maxinacube-themeurl-field">
					<TextField
						title={__('Facebook URL', 'maxinacube-theme')}
						data={{
					...
					<TextField
						title={__('Twitter URL', 'maxinacube-theme')}
						data={{
					...
					<TextField
						title={__('Youtube URL', 'maxinacube-theme')}
						data={{
					...
					<TextField
						title={__('Instagram URL', 'maxinacube-theme')}
						data={{
