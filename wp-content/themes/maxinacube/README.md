# Maxinacube Theme (to be updated!)

See how to develop locally Maxinacube theme at [Local Development Setup](../../../.local/docs/local-development-setup.md) and [Theme Development](../../../.local/docs/theme-development.md).
